    ...
    <Form form={form} layout="vertical" requiredMark={false} initialValues={{ price: 0 ,purchase_price: 0}}>
      <Row gutter={16}>
        ...
        <Col xs={24} sm={12}>
          ...
          >
            <InputNumber placeholder="Enter price" min={0} prefix="$" precision={2} style={{ width: '100%' }} />
          </Form.Item>
        </Col>
        <Col xs={24} sm={12}>
          <Form.Item
          ...
          >
            <InputNumber placeholder="Enter purchase price" min={0} prefix="$" precision={2} style={{ width: '100%' }} />
          </Form.Item>
        </Col>
        <Col xs={24} sm={12}>
          <Form.Item
